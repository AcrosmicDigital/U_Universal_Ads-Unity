...
{
    public class TestIntertitial1 : Intertitial<TestIntertitial1>
    {
        ...
        protected override string adUnitId_Android => TestEnv.Ads.AdUnit.Interstitial_Android.ToString();
        protected override string adUnitId_IOS => TestEnv.Ads.AdUnit.Interstitial_iOS.ToString();
